...
const NotFound = () => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col bg-white justify-center items-center space-y-6 mt-12 pb-16">
                ...
                <button onClick={() => navigate("/")} className="text-md text-white font-semibold bg-indigo-500 rounded-lg px-6 py-4">Go To Home</button>
            </div>
        </>
    )
}
