...
import { getUser, loginUser, logoutUser, registerUser, updateProfile } from "../controllers/user.controller.js";
...
router.route("/edit/profile").put(verifyToken, isUserVerified, uploadAvatar.single("avatar"), updateProfile);
